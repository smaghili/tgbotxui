...
class Database:
    ...
    async def ensure_delegated_admin_profile(self, telegram_user_id: int) -> None:
        ...
        await DelegatedAdminFinanceRepository(db=self).ensure_profile(telegram_user_id)

    async def get_delegated_admin_profile(self, telegram_user_id: int) -> Dict[str, Any]:
        from bot.repositories.delegated_admin_finance_repository import DelegatedAdminFinanceRepository
        return await DelegatedAdminFinanceRepository(db=self).get_profile(telegram_user_id)
    ...
    async def update_delegated_admin_profile(
        ...
        *,
        ...
        from bot.repositories.delegated_admin_finance_repository import DelegatedAdminFinanceRepository
        return await DelegatedAdminFinanceRepository(db=self).update_profile(
    ...
    async def list_recent_wallet_transactions(
        ...
        *,
        ...
        from bot.repositories.delegated_admin_finance_repository import DelegatedAdminFinanceRepository
        return await DelegatedAdminFinanceRepository(db=self).list_recent_wallet_transactions(
            telegram_user_id=telegram_user_id,
            limit=limit,
        )
    ...
    async def list_scope_wallet_transactions(
        ...
        *,
        ...
        from bot.repositories.delegated_admin_finance_repository import DelegatedAdminFinanceRepository
        return await DelegatedAdminFinanceRepository(db=self).list_scope_wallet_transactions(
            telegram_user_ids,
    ...
    async def get_delegate_panel_pricing(self, *, telegram_user_id: int, panel_id: int) -> Dict[str, Any] | None:
        from bot.repositories.delegated_admin_finance_repository import DelegatedAdminFinanceRepository
        return await DelegatedAdminFinanceRepository(db=self).get_panel_pricing(
            telegram_user_id=telegram_user_id,
            panel_id=panel_id,
        )
    ...
    async def list_delegate_panel_pricing(self, *, telegram_user_id: int) -> List[Dict[str, Any]]:
        from bot.repositories.delegated_admin_finance_repository import DelegatedAdminFinanceRepository
        return await DelegatedAdminFinanceRepository(db=self).list_panel_pricing(telegram_user_id=telegram_user_id)
    ...
    async def set_delegate_panel_pricing(
        ...
        *,
        ...
        from bot.repositories.delegated_admin_finance_repository import DelegatedAdminFinanceRepository
        return await DelegatedAdminFinanceRepository(db=self).set_panel_pricing(
            telegram_user_id=telegram_user_id,
            panel_id=panel_id,
    ...
    async def list_recent_actor_audit_logs(
        ...
        *,
        ...
        from bot.repositories.delegated_admin_finance_repository import DelegatedAdminFinanceRepository
        return await DelegatedAdminFinanceRepository(db=self).list_recent_actor_audit_logs(
    ...
    async def list_scope_audit_logs(
        ...
        *,
        ...
        from bot.repositories.delegated_admin_finance_repository import DelegatedAdminFinanceRepository
        return await DelegatedAdminFinanceRepository(db=self).list_scope_audit_logs(
            actor_user_ids,
            actions=actions,
            created_at_from=created_at_from,
            created_at_to=created_at_to,
