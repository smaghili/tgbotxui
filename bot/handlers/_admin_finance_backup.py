"""Admin finance routes: menus, sales/today reports, pricing, and wallet changes.

Wallet mutations must pass ``_can_manage_finance_target`` (delegates) or root checks
before calling ``FinancialService`` adjustment APIs.
"""
