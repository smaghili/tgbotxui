...
TEXTS: dict[str, dict[Lang, str]] = {
    ...
    "notif_root_enduser_service_defaults_hint": {
        "fa": "سه مورد آخر فقط برای مدیر اصلی است: پیش‌فرض اعلان سرویس برای همهٔ کاربران عادی (خود مدیر اصلی مستثنی است).",
        "en": "Last three rows (root only): default service alerts for all end users (root admins excluded).",
    },
    "notif_toggle_denied": {
    ...
    "notif_kind_auto_cleanup_deleted": {"fa": "مدیر: حذف خودکار کاربر", "en": "Manager: auto-deleted user"},
    ...
    "notif_kind_user_service_threshold": {
        "fa": "پیش‌فرض کاربران: کم‌حجم سرویس",
        "en": "Default: end-user low traffic",
    },
    "notif_kind_user_service_depleted": {
        "fa": "پیش‌فرض کاربران: اتمام حجم سرویس",
        "en": "Default: end-user traffic depleted",
    },
    "notif_kind_user_service_expired": {
        "fa": "پیش‌فرض کاربران: انقضای سرویس",
        "en": "Default: end-user service expiry",
    },
    ...
    "notif_kind_user_traffic_increased": {"fa": "کاربر: اطلاع افزایش حجم", "en": "User: traffic increased notice"},
    "notif_kind_user_expiry_extended": {"fa": "کاربر: اطلاع افزایش روز", "en": "User: expiry extended notice"},
    "config_full_caption": {
