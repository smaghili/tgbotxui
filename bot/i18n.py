...
TEXTS: dict[str, dict[Lang, str]] = {
    ...
    "notif_root_enduser_service_defaults_title": {
        "fa": "اعلان‌های کاربران عادی (سرویس)",
        "en": "End-user service alerts (defaults)",
    },
    "notif_root_enduser_service_defaults_hint": {
        "fa": "فقط مدیر اصلی این بخش را می‌بیند. هر تیک برای همهٔ کاربران عادی اعمال می‌شود (به‌جز خود مدیر اصلی).",
        "en": "Root admins only. Each toggle applies to all non–root-admin end users (root admins are not affected).",
    },
    "notif_toggle_denied": {
    ...
    "notif_kind_manager_service_depleted": {"fa": "مدیر: هشدار اتمام حجم کاربر", "en": "Manager: user traffic depleted"},
    "notif_kind_manager_service_expired": {"fa": "مدیر: هشدار اتمام زمان کاربر", "en": "Manager: user service expired"},
    "notif_kind_manager_service_threshold": {"fa": "مدیر: هشدار کم‌حجم کاربر", "en": "Manager: user low traffic alert"},
    "notif_kind_user_service_threshold": {"fa": "کاربر: هشدار کم‌حجم سرویس", "en": "User: low traffic alert"},
    "notif_kind_user_service_depleted": {"fa": "کاربر: هشدار تمام شدن حجم سرویس", "en": "User: traffic depleted"},
    "notif_kind_user_service_expired": {"fa": "کاربر: هشدار انقضای سرویس", "en": "User: service expiry notice"},
    "notif_kind_delegated_traffic_low": {"fa": "ادمین فرعی: هشدار کم‌حجم پنل", "en": "Delegated admin: panel low traffic"},
    "notif_kind_delegated_traffic_depleted": {"fa": "ادمین فرعی: هشدار اتمام حجم پنل", "en": "Delegated admin: panel traffic depleted"},
    "notif_kind_delegated_expiry_low": {"fa": "ادمین فرعی: هشدار نزدیک انقضای پنل", "en": "Delegated admin: panel expiry soon"},
    "notif_kind_delegated_expiry_expired": {"fa": "ادمین فرعی: هشدار انقضای پنل", "en": "Delegated admin: panel expired"},
