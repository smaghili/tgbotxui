...
TEXTS: dict[str, dict[Lang, str]] = {
    ...
    "notif_kind_auto_cleanup_deleted": {"fa": "حذف خودکار کاربر", "en": "Auto-deleted user"},
    "notif_kind_manager_service_depleted": {"fa": "هشدار اتمام حجم (مدیر)", "en": "Traffic depleted (manager)"},
    "notif_kind_manager_service_expired": {"fa": "هشدار اتمام زمان (مدیر)", "en": "Service expired (manager)"},
    "notif_kind_manager_service_threshold": {"fa": "هشدار کم‌حجم برای مدیر", "en": "Low traffic alert (manager)"},
    "notif_kind_user_service_threshold": {"fa": "هشدار کم‌حجم برای کاربر", "en": "Low traffic alert (user)"},
    "notif_kind_user_service_depleted": {"fa": "هشدار تمام شدن حجم (کاربر)", "en": "Traffic depleted (user)"},
    "notif_kind_user_service_expired": {"fa": "هشدار انقضا (کاربر)", "en": "Expiry notice (user)"},
    "notif_kind_delegated_traffic_low": {"fa": "هشدار کم‌حجم پنل (ادمین فرعی)", "en": "Delegated low traffic"},
    "notif_kind_delegated_traffic_depleted": {"fa": "هشدار اتمام حجم پنل (ادمین فرعی)", "en": "Delegated traffic depleted"},
    "notif_kind_delegated_expiry_low": {"fa": "هشدار نزدیک انقضا (ادمین فرعی)", "en": "Delegated expiry soon"},
    "notif_kind_delegated_expiry_expired": {"fa": "هشدار انقضا (ادمین فرعی)", "en": "Delegated expired"},
    "notif_kind_user_traffic_increased": {"fa": "اطلاع افزایش حجم به کاربر نهایی", "en": "User traffic increase notice"},
    "notif_kind_user_expiry_extended": {"fa": "اطلاع افزایش روز به کاربر نهایی", "en": "User expiry extension notice"},
    "config_full_caption": {
