...
TEXTS: dict[str, dict[Lang, str]] = {
    ...
    "btn_bot_notifications": {"fa": "🔕 مدیریت پیام‌های ربات", "en": "🔕 Bot message settings"},
    ...
    "admin_change_client_owner": {"fa": "🧭 تغییر نماینده کاربر", "en": "🧭 Change client delegate"},
    "admin_pick_client_owner": {"fa": "نماینده جدید کاربر را انتخاب کنید:", "en": "Select the new delegate:"},
    "admin_client_owner_changed": {"fa": "نماینده کاربر با موفقیت تغییر کرد.", "en": "Client delegate changed successfully."},
    "admin_root_label": {"fa": "مدیر اصلی", "en": "Root Admin"},
    ...
    "panel_action_groups": {"fa": "👥 مدیریت گروه‌ها", "en": "👥 Group Management"},
    ...
    "panel_group_menu_title": {"fa": "مدیریت گروه‌های پنل", "en": "Panel Group Management"},
    "panel_group_add": {"fa": "➕ افزودن گروه", "en": "➕ Add Group"},
    "panel_group_list": {"fa": "📋 لیست گروه‌ها", "en": "📋 Group List"},
    "panel_group_list_title": {"fa": "لیست گروه‌های این پنل:", "en": "Groups for this panel:"},
    "panel_group_add_prompt": {"fa": "نام گروه جدید را وارد کنید:", "en": "Enter the new group name:"},
    "panel_group_add_invalid": {"fa": "نام گروه معتبر نیست.", "en": "Group name is invalid."},
    "panel_group_created": {"fa": "گروه {name} ساخته شد.", "en": "Group {name} was created."},
    ...
    "admin_delegated_parent_root_unset": {"fa": "اتصال به روت برداشته شد.", "en": "Root attachment was removed."},
    "admin_delegated_parent_toggle_no_alt": {
        "fa": "مدیر جایگزین برای خروج از روت پیدا نشد. ابتدا از بخش زیرمجموعه‌ها یک مدیر برای این ادمین ثبت کنید.",
        "en": "No alternate manager found. First assign a delegate manager from subordinates.",
    },
    ...
    "admin_delegated_subordinates": {"fa": "زیرمجموعه‌ها 👥", "en": "Subordinates 👥"},
    "admin_delegated_subordinates_title": {"fa": "زیرمجموعه‌های نماینده: {title}\n\nبرای افزودن یا حذف ادمین از زیر این نماینده، دکمه روبروی همان ادمین را بزنید.", "en": "Subordinates of delegate: {title}\n\nUse the button next to each admin to add or remove them from this delegate."},
    "admin_delegated_subordinate_add": {"fa": "افزودن ➕", "en": "Add ➕"},
    "admin_delegated_subordinate_remove": {"fa": "حذف ❌", "en": "Remove ❌"},
    ...
    "admin_activity_action_create_client": {
        "fa": "ساخت کاربر جدید توسط زیرمجموعه‌ها",
        "en": "Create client (by subordinates)",
    },
    "admin_activity_action_toggle_client": {
        "fa": "تغییر وضعیت کاربر توسط زیرمجموعه‌ها",
        "en": "Toggle client status (by subordinates)",
    },
    "admin_activity_action_rotate_client": {
        "fa": "چرخش کانفیگ کاربر توسط زیرمجموعه‌ها",
        "en": "Rotate client config (by subordinates)",
    },
    "admin_activity_action_set_tg_id": {
        "fa": "تغییر آیدی تلگرام کاربر توسط زیرمجموعه‌ها",
        "en": "Set client Telegram id (by subordinates)",
    },
    "admin_activity_action_add_traffic": {
        "fa": "افزایش حجم کاربر توسط زیرمجموعه‌ها",
        "en": "Increase client traffic (by subordinates)",
    },
    "admin_activity_action_add_days": {
        "fa": "افزایش روز کاربر توسط زیرمجموعه‌ها",
        "en": "Extend client expiry (by subordinates)",
    },
    "admin_activity_action_delete_client": {
        "fa": "حذف کاربر توسط زیرمجموعه‌ها",
        "en": "Delete client (by subordinates)",
    },
    "admin_activity_action_set_total_gb": {
        "fa": "تنظیم حجم کاربر توسط زیرمجموعه‌ها",
        "en": "Set client traffic (by subordinates)",
    },
    "admin_activity_action_set_expiry_days": {
        "fa": "تنظیم تاریخ انقضا توسط زیرمجموعه‌ها",
        "en": "Set client expiry (by subordinates)",
    },
    "admin_activity_action_reset_traffic": {
    ...
    "notif_menu_title": {
        "fa": "مدیریت پیام‌های ربات\n\n✅ ارسال فعال است.\n⬜ ارسال غیرفعال است.\nروی هر مورد بزنید تا وضعیت عوض شود.",
        "en": "Bot message settings\n\n✅ Sending enabled.\n⬜ Sending disabled.\nTap a row to toggle.",
    },
    "notif_menu_role_filtered": {
        "fa": "فقط مواردی که برای نقش شما معنی‌دار است نمایش داده شده است.",
        "en": "Only categories relevant to your role are shown.",
    },
    "notif_root_enduser_service_defaults_hint": {
        "fa": "پنج ردیف آخر فقط برای مدیر اصلی است: پیش‌فرض اعلان‌های کاربر برای همهٔ کاربران عادی (خود مدیر اصلی مستثنی است).",
        "en": "Last five rows (root only): default user alerts for all end users (root admins excluded).",
    },
    "notif_toggle_denied": {
        "fa": "این مورد برای حساب شما قابل تغییر نیست.",
        "en": "This category cannot be changed for your account.",
    },
    "notif_saved": {"fa": "ذخیره شد.", "en": "Saved."},
    "notif_kind_auto_cleanup_deleted": {"fa": "حذف خودکار کاربر", "en": "Auto-delete user"},
    "notif_kind_manager_service_depleted": {"fa": "هشدار اتمام حجم کاربر", "en": "Client traffic depleted alert"},
    "notif_kind_manager_service_expired": {"fa": "هشدار اتمام زمان کاربر", "en": "Client service expired alert"},
    "notif_kind_manager_service_threshold": {"fa": "هشدار کم‌حجم کاربر", "en": "Client low traffic alert"},
    "notif_kind_user_service_threshold": {
        "fa": "کاربر: هشدار کم‌حجم سرویس (پیش‌فرض همه)",
        "en": "User: low traffic (default for all)",
    },
    "notif_kind_user_service_depleted": {
        "fa": "کاربر: هشدار اتمام حجم سرویس (پیش‌فرض همه)",
        "en": "User: traffic depleted (default for all)",
    },
    "notif_kind_user_service_expired": {
        "fa": "کاربر: هشدار انقضای سرویس (پیش‌فرض همه)",
        "en": "User: service expiry (default for all)",
    },
    "notif_kind_delegated_traffic_low": {"fa": "هشدار کم‌حجم پنل", "en": "Panel low traffic alert"},
    "notif_kind_delegated_traffic_depleted": {"fa": "هشدار اتمام حجم پنل", "en": "Panel traffic depleted alert"},
    "notif_kind_delegated_expiry_low": {"fa": "هشدار نزدیک انقضای پنل", "en": "Panel expiry soon alert"},
    "notif_kind_delegated_expiry_expired": {"fa": "هشدار انقضای پنل", "en": "Panel expired alert"},
    "notif_kind_user_traffic_increased": {
        "fa": "کاربر: اطلاع افزایش حجم (پیش‌فرض همه)",
        "en": "User: traffic increased (default for all)",
    },
    "notif_kind_user_expiry_extended": {
        "fa": "کاربر: اطلاع افزایش روز (پیش‌فرض همه)",
