...
TEXTS: dict[str, dict[Lang, str]] = {
    ...
    "admin_delegated_panel_price_gb": {"fa": "قیمت حجم پنل", "en": "Panel GB Price"},
    "admin_delegated_panel_price_day": {"fa": "قیمت زمان پنل", "en": "Panel Day Price"},
    "admin_delegated_panel_price_pick_field": {"fa": "نوع قیمت را برای پنل {panel_name} انتخاب کنید:", "en": "Choose the pricing field for panel {panel_name}:"},
